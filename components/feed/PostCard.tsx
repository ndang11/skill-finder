...
export default function PostCard({
	...
	const whatsAppLink = `https://wa.me/${post.authorPhone.replace(/\D/g, "")}?text=${encodeURIComponent(`Hello ${post.authorName}, I saw your post on Skill Finder and I'd like to enquire about your services.`)}`;
